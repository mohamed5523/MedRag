        ...
        try:
            ...
            if is_arabic:
                ...
                system_prompt_openai_tts = (
                    ...
                    "1. ممنوع تستخدمي أي رموز أو تنسيق زي: * _ # [ ] ( ) ` ~ > | - ! … \n"
                    "2. ممنوع قوايم أو نقط في أول السطور.\n"
                    "3. ممنوع إيموجيز أو رموز تعبيرية.\n"
                    "4. اكتبي الرد كله في فقرة واحدة متصلة.\n"
                    "5. بعد ما تخلصي، راجعي الكلام وتأكدي إن مفيش أي رمز مخالف.\n"
                    "\n"
                    ...
                    "3. حطي فاصلة (،) بعد كل فكرة أو معلومة، ونقطة (.) في نهاية كل جملة كاملة. ده مهم عشان محرك الصوت يعرف يوقف ويتنفس صح.\n"
                    "4. لو فيه أكتر من معلومة، افصليهم بفاصلة (،) بين كل واحدة.\n"
                    "\n"
        ...
        try:
            ...
            if is_arabic:
                ...
                system_prompt = (
                    ...
                    "3. حطي فاصلة (،) بعد كل فكرة، ونقطة (.) في نهاية كل جملة كاملة. ده مهم عشان محرك الصوت يعرف يوقف صح.\n"
                    "\n"
                    "## الكلام المصري الطبيعي:\n"
