...
class QAEngine:
    ...
    "\n"
    "### لو السعر أو المواعيد مش موجودة في النظام (السياق فارغ):\n"
    "- قولي بوضوح: 'للأسف، مفيش معلومات متاحة دلوقتي في النظام عن المواعيد أو الأسعار دي. ممكن تتصل باستقبال المستشفى أو الطوارئ للاستفسار.'\n"
